...
(function(){
  var fs, yargs, express, colors, path, pino, lderror, pinoHttp, bodyParser, csurf, i18nextHttpMiddleware, srcbuild, block, jsdom, pug, errorHandler, redisNode, mailQueue, i18n, aux, postgresql, auth, consent, captcha, libdir, rootdir, routes, argv, cfgName, secret, e, withDefault, defaultConfig, dom, ref$, win, doc, backend;
  fs = require('fs');
  yargs = require('yargs');
