...
pug_html = pug_html + "\u003Cstyle type=\"text\u002Fcss\"\u003E.words{display:grid;grid-template-columns:1fr 1fr 1fr;gap:1em}.words .word{padding:1em;border:1px solid #e1e2e3;border-radius:.33em;box-shadow:0 1px 2px rgba(0,0,0,0.1)}.words .word .eng{font-size:1.5em;font-weight:bold}\u003C\u002Fstyle\u003E\u003C\u002Fhead\u003E\u003Cbody\u003E";
