...
pug_mixins["nbr"](2);
pug_html = pug_html + "\u003Cdiv class=\"w-1024 rwd mx-auto\"\u003E\u003Cdiv class=\"mb-5\"\u003E\u003Cdiv class=\"d-flex align-items-end g-1\"\u003E\u003Ch2 class=\"mb-0\"\u003E書單列表\u003C\u002Fh2\u003E\u003Cdiv class=\"flex-grow-1\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"btn btn-sm btn-outline-primary\" ld=\"new-list\"\u003E新增書單\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Chr\u003E\u003Cdiv\u003E\u003Cdiv class=\"readlist-item d-flex g-2\" ld-each=\"readlist\"\u003E\u003Cdiv ld=\"title\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"text-truncate\" ld=\"description\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv ld=\"createdtime\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md\"\u003E\u003Cdiv class=\"d-flex align-items-end g-1\"\u003E\u003Ch2 class=\"mb-0\"\u003E我的書單\u003C\u002Fh2\u003E\u003Cdiv class=\"flex-grow-1\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"btn btn-sm btn-outline-primary\" ld=\"new-list\"\u003E新增書單\u003C\u002Fdiv\u003E\u003Cdiv class=\"btn-group mr-1\"\u003E\u003Cdiv class=\"btn btn-sm btn-outline-primary\" ld=\"scan\"\u003E掃書\u003C\u002Fdiv\u003E\u003Cdiv class=\"btn btn-sm btn-outline-primary\" ld=\"new-read\"\u003E手動\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"btn btn-sm btn-outline-primary\" ld=\"new-book\"\u003E追加書籍\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Chr\u003E\u003Cdiv class=\"mb-5\"\u003E\u003Cdiv class=\"book head border-bottom pb-2 mb-2\"\u003E\u003Cdiv\u003E書名\u003C\u002Fdiv\u003E\u003Cdiv\u003E開讀日\u003C\u002Fdiv\u003E\u003Cdiv\u003E完讀日\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"d-none\" ld=\"read-loading\"\u003E載入中\u003C\u002Fdiv\u003E\u003Cdiv class=\"d-none\" ld=\"no-read\"\u003E沒有書\u003C\u002Fdiv\u003E\u003Cdiv class=\"book\" ld-each=\"read\"\u003E\u003Cdiv\u003E\u003Cdiv ld=\"title\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"text-sm text-muted\" ld=\"isbn\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv ld=\"startdate\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv ld=\"enddate\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"col-md\"\u003E\u003Cdiv class=\"aspect-ratio ratio-1by1\"\u003E\u003Cdiv ld=\"chart\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
pug_mixins["script"]([
...
pug_html = pug_html + "\u003Cscript type=\"module\"\u003E(function(n){return n.apply({})})(function(){return servebase.corectx(function(n){var r;r=n.core;return r.init().then(function(){return r.auth.ensure().then(function(){var e,o;e={loading:true,isLoading:function(){return!!this.loading},get:function(){if(this.loading){return[]}else{return this.list||[]}},update:function(){return this.fetch().then(function(){return o.render()})},fetch:function(){var t=this;this.loading=true;return debounce(350).then(function(){return ld$.fetch(\"\u002Fapi\u002Freadlist\",{method:\"GET\"},{type:\"json\"})}).then(function(n){return t.lists=n}).then(function(){return ld$.fetch(\"\u002Fapi\u002Fread\u002F\"+r.user.key,{method:\"GET\"},{type:\"json\"})}).then(function(n){return t.list=n.map(function(n){var t;return t=n.read,t.book=n.book,t})})[\"finally\"](function(){return t.loading=false})}};o=new ldview({root:document.body,initRender:false,action:{click:{scan:function(){return r.ldcvmgr.get({ns:\"local\",name:\"scanner\"}).then(function(n){var t;n==null&&(n={});if(!n.key){return}r.loader.on();t={list:[{book:n.key,enddate:new Date}]};return ld$.fetch(\"\u002Fapi\u002Fread\u002F\",{method:\"POST\"},{json:t})[\"finally\"](function(){return r.loader.off()}).then(function(){return e.update()})})},\"new-list\":function(){return r.ldcvmgr.get({ns:\"local\",name:\"new-list\"}).then(function(){})},\"new-read\":function(){return r.ldcvmgr.get({ns:\"local\",name:\"new-read\"}).then(function(){return e.update()})},\"new-book\":function(){return r.ldcvmgr.get({ns:\"local\",name:\"new-book\"})}}},handler:{\"read-loading\":function(n){var t;t=n.node;return t.classList.toggle(\"d-none\",!e.isLoading())},\"no-read\":function(n){var t;t=n.node;return t.classList.toggle(\"d-none\",e.isLoading()||e.get().length)},readlist:{list:function(){return e.lists||[]},key:function(n){return n.key},view:{text:{title:function(n){var t,e;t=n.node,e=n.ctx;return e.title||\"未命名\"},description:function(n){var t,e;t=n.node,e=n.ctx;return e.description||\"\"},createdtime:function(n){var t,e;t=n.node,e=n.ctx;if(!e.createdtime){return\"n\u002Fa\"}else{return dayjs(e.createdtime).format(\"YYYY\u002FMM\u002FDD hh:mm:ss\")}}}}},read:{list:function(){return e.get()},key:function(n){return n.key},view:{init:{startdate:function(n){var t,e,r;t=n.node,e=n.ctx;r=new lddatetimepicker({host:t});return r.on(\"change\",function(n){console.log(n);e.startdate=n;return o.render()})}},action:{click:{startdate:function(){}}},text:{title:function(n){var t,e;t=n.node,e=n.ctx;return e.book.title},isbn:function(n){var t,e;t=n.node,e=n.ctx;return e.book.isbn},startdate:function(n){var t,e;t=n.node,e=n.ctx;if(!e.startdate){return\"n\u002Fa\"}else{return dayjs(e.startdate).format(\"YYYY\u002FMM\u002FDD hh:mm:ss\")}},enddate:function(n){var t,e;t=n.node,e=n.ctx;if(!e.enddate){return\"n\u002Fa\"}else{return dayjs(e.enddate).format(\"YYYY\u002FMM\u002FDD hh:mm:ss\")}}}}}}});return Promise.resolve().then(function(){return o.render()}).then(function(){return e.fetch()}).then(function(){return o.render()}).then(function(){return r.manager.from({ns:\"chart\",name:\"pie\"},{root:o.get(\"chart\")}).then(function(n){var t;t=n[\"interface\"];t.parse();t.bind();t.resize();return t.render()})})})})})});\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
