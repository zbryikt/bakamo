...
pug_html = pug_html + "\u003Cdiv class=\"w-100 h-100\"\u003E\u003Cdiv class=\"d-flex align-items-center justify-content-center w-100 h-100\"\u003E\u003Cdiv\u003E\u003Cdiv\u003E\u003Cdiv class=\"d-flex question done align-items-center\" ld-each=\"q\"\u003E\u003Cdiv class=\"num\" ld=\"n1\"\u003E0\u003C\u002Fdiv\u003E\u003Cdiv\u003E-\u003C\u002Fdiv\u003E\u003Cdiv class=\"num\" ld=\"n2\"\u003E0\u003C\u002Fdiv\u003E\u003Cdiv\u003E=\u003C\u002Fdiv\u003E\u003Cdiv class=\"num\" ld=\"ans\"\u003E0\u003C\u002Fdiv\u003E\u003Cdiv class=\"result\" ld=\"result\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"elapsed\" ld=\"elapsed\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"d-flex question align-items-center\"\u003E\u003Cdiv class=\"num\" ld=\"n1\"\u003E0\u003C\u002Fdiv\u003E\u003Cdiv\u003E-\u003C\u002Fdiv\u003E\u003Cdiv class=\"num\" ld=\"n2\"\u003E0\u003C\u002Fdiv\u003E\u003Cdiv\u003E=\u003C\u002Fdiv\u003E\u003Cdiv class=\"num d-flex\"\u003E\u003Cdiv ld=\"ans\"\u003E0\u003C\u002Fdiv\u003E\u003Cdiv class=\"blink\"\u003E_\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"result\" ld=\"result\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"position-absolute mx-auto\" style=\"bottom:2em;font-size:3em;font-weight:700;left:0;right:0;width:fit-content\"\u003E\u003Cdiv ld=\"tick\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv ld=\"avg\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
pug_mixins["script"]([
...
pug_html = pug_html + "\u003Cscript type=\"module\"\u003Eservebase.corectx(function(n){var t,o,u,s,e,a;t=n.core;o={correct:new Audio(\"\u002Fassets\u002Fsfx\u002Fcorrect.mp3\"),wrong:new Audio(\"\u002Fassets\u002Fsfx\u002Fwrong.mp3\")};u={q:[],stat:{count:0,t:0}};s=new ldview({root:document.body,text:{n1:function(n){var t;t=n.node;return u.n1},n2:function(n){var t;t=n.node;return u.n2},ans:function(){return u.ans||\"\"},avg:function(){return(u.stat.t\u002F(1e3*(u.stat.count||1))).toFixed(1)+\"s\"}},handler:{result:function(n){var t;t=n.node;return t.setAttribute(\"class\",\"result \"+(u.result||\"\"))},q:{list:function(){return u.q},view:{text:{n1:function(n){var t,e;t=n.node,e=n.ctx;return e.n1},n2:function(n){var t,e;t=n.node,e=n.ctx;return e.n2},ans:function(n){var t;t=n.ctx;return t.ans||\"\"},elapsed:function(n){var t;t=n.ctx;return(t.elapsed\u002F1e3).toFixed(1)+\"s\"}},handler:{result:function(n){var t,e;t=n.node,e=n.ctx;return t.setAttribute(\"class\",\"result \"+(e.result||\"\"))}}}}}});e=function(n){var t;t=s.get(\"tick\");if(u.t==null){u.t=n}u.ct=n;t.textContent=((n-u.t)\u002F1e3).toFixed(1)+\"s\";return requestAnimationFrame(e)};requestAnimationFrame(function(n){return e(n)});document.addEventListener(\"keyup\",function(n){var t,e,r;if(n.keyCode\u003E=48&&n.keyCode\u003C=57){u.ans=(u.ans||\"\")+String.fromCharCode(n.keyCode);return s.render()}else if(n.keyCode===8){t=u.ans||\"\";u.ans=t.substring(0,(e=t.length-1)\u003E0?e:0);return s.render()}else if(n.keyCode===13){r={n1:u.n1,n2:u.n2,ans:u.ans};r.elapsed=u.ct-u.t;delete u.t;if(r.n1-r.n2===+r.ans){u.stat.t+=r.elapsed;u.stat.count+=1;o.correct.play();r.result=\"correct\"}else{o.wrong.play();r.result=\"wrong\"}u.q=[r];u.ans=\"\";return a()}});a=function(){u.n1=Math.round(Math.random()*5)+5;u.n2=Math.round(Math.random()*5)+1;return s.render()};return a()});\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
